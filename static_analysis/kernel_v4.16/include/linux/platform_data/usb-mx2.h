...
struct mx21_usbh_platform_data {
	...
	u16 	enable_host1,
		enable_host2,
		enable_otg_host, /* enable "OTG" port (as host) */
		host1_xcverless, /* traceiverless host1 port */
		host1_txenoe, /* output enable host1 transmit enable */
		otg_ext_xcvr, /* external tranceiver for OTG port */
		unused;
};
