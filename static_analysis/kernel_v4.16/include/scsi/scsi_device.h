...
#define SCSI_VPD_PG_LEN                255
	...
	unsigned security_supported;	/* Supports Security Protocols */
	...
	unsigned lun_in_cdb;		/* Store LUN bits in CDB[1] */
	unsigned unmap_limit_for_ws;	/* Use the UNMAP limit for WRITE SAME */
